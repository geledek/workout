...
| Role | Who | Function |
|------|-----|----------|
| 🏥 **Architect** | Sarah (Physio) | Designs the rehab program. Has final say on exercise selection and progression. When she says stop, you stop. |
| 🎯 **Code Reviewer** | Andy (PT) | Weekly gym sessions. Implements Sarah's designs. Catches form issues before they become injuries. |
| 🤖 **Pair Programmer** | Claude (AI) | Generates weekly plans, unpacks exercise shorthand, tracks progressions, reminds you what to monitor. |
...
| ⚖️ **L/R differences** | Identify imbalance patterns over time |
...
|--------|-------|--------|----------|
| 🫀 VO2Max | 38 | 45 | ![Progress](https://img.shields.io/badge/38%20→%2045-0%25-red?style=flat-square) |
| 🏃 5km | — | 25:00 | ![Progress](https://img.shields.io/badge/Target-25%3A00-blue?style=flat-square) |
